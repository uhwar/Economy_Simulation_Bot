...
async def add_balance(user_id: int, amount: int):
    try:
        ...
        print(f"Error adding balance for user {user_id}: {e}")
...
async def remove_balance(user_id: int, amount: int):
    try:
        ...
        print(f"Error removing balance for user {user_id}: {e}")
...
async def deposit_to_bank(user_id: int, amount: int):
    try:
        ...
        print(f"Error depositing to bank for user {user_id}: {e}")
...
async def withdraw_from_bank(user_id: int, amount: int):
    try:
        ...
        print(f"Error withdrawing from bank for user {user_id}: {e}")
...
async def calculate_interest(user_id: int):
    try:
        ...
        print(f"Error calculating interest for user {user_id}: {e}")
        return 0
